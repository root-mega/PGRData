...
function XUiColorTableShop:OnAwake()
    ...
    self.ShopItemTextColor.CanBuyColor = CS.XGame.ClientConfig:GetString("ColorTableShopItemTextCanBuyColorJP")
    self.ShopItemTextColor.CanNotBuyColor = CS.XGame.ClientConfig:GetString("ColorTableShopItemTextCanNotBuyColorJP")
