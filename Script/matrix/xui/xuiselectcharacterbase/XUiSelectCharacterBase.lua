...
function XUiSelectCharacterBase:InitFilter()
    ...
    if self.InitSeleCharId then
        XMVCA.XCommonCharacterFilt:SetNotSortTrigger()
        self.PanelFilter:DoSelectCharacter(self.InitSeleCharId)
    end
end
...
function XUiSelectCharacterBase:RefreshModel()
    ...
    self.RoleModelPanel:UpdateCharacterModel(self.CurCharacter.Id, self.PanelRoleModel, self.Name, cb)
end
