...
function XPassportAgency:InitRpc()
    ...
    XRpc.PassportBuyPassportResponse = Handler(self, self.PassportBuyPassportResponse)
end
...
function XPassportAgency:PassportBuyPassportResponse(data)
    self._Model:PassportBuyPassportResponse(data)
end
