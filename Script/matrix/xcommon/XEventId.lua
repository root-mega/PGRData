...
XEventId = {
    ...
    -- 手柄类型更新
    EVENT_JOYSTICK_TYPE_CHANGED = "EVENT_JOYSTICK_TYPE_CHANGED",    --邮件事件
    ...
    EVENT_SC_ACTION_MAPINIT = "EVENT_SC_ACTION_MAPINIT", --地图初始化
    EVENT_SC_ACTION_BALLREMOVE = "EVENT_SC_ACTION_BALLREMOVE", --消球
    EVENT_SC_ACTION_BALLDROP = "EVENT_SC_ACTION_BALLDROP", --落球
    EVENT_SC_ACTION_BALLADD = "EVENT_SC_ACTION_BALLADD", --增球
    EVENT_SC_ACTION_SHUFFLE = "EVENT_SC_ACTION_SHUFFLE", --洗球
    EVENT_SC_ACTION_INTERRUPT = "EVENT_SC_ACTION_INTERRUPT", --中断
    EVENT_SC_ACTION_SETTLESCORE = "EVENT_SC_ACTION_SETTLESCORE", --结算分数
    EVENT_SC_ACTION_BALLSWAP = "EVENT_SC_ACTION_BALLSWAP", --换球
    EVENT_SC_ACTION_ADDSTEP = "EVENT_SC_ACTION_ADDSTEP", --增加步数
    EVENT_SC_ACTION_SUBSTEP = "EVENT_SC_ACTION_SUBSTEP", --减少步数
    EVENT_SC_ACTION_BALLCHANGECOLOR = "EVENT_SC_ACTION_BALLCHANGECOLOR", --球换色
    EVENT_SC_ACTION_ADDBUFF = "EVENT_SC_ACTION_ADDBUFF", --增加buff
    EVENT_SC_ACTION_SUBBUFF = "EVENT_SC_ACTION_SUBBUFF", --移除buff
    EVENT_SC_ACTION_BOSSSKILL = "EVENT_SC_ACTION_BOSSSKILL", --boss技能
    EVENT_SC_ACTION_BOSSSKIPSKILL = "EVENT_SC_ACTION_BOSSSKIPSKILL", --boss跳过技能
    EVENT_SC_ACTION_ENERGYCHANGE = "EVENT_SC_ACTION_ENERGYCHANGE", --能量改变
    EVENT_SC_ACTION_CDCHANGE = "EVENT_SC_ACTION_CDCHANGE", --技能cd改变
    EVENT_SC_ACTION_ACTIONFINISH = "EVENT_SC_ACTION_ACTIONFINISH", --Action结束
    EVENT_SC_ACTION_ACTIONLIST_OVER = "EVENT_SC_ACTION_ACTIONLIST_OVER", --Action队列结束
    EVENT_SC_ACTION_LEFTTIME_CHANGE = "EVENT_SC_ACTION_LEFTTIME_CHANGE", --关卡剩余时间改变
    EVENT_SC_ACTION_BUFF_LEFTTIME_CHANGE = "EVENT_SC_ACTION_BUFF_LEFTTIME_CHANGE", --buff剩余时间改变
    EVENT_SC_ACTION_MAPRESET = "EVENT_SC_ACTION_MAPRESET", --地图重置
    EVENT_SC_BATTLESHOW_COMBOPLAY = "EVENT_SC_BATTLESHOW_COMBOPLAY", --播放战斗连击表演
    EVENT_SC_BATTLESHOW_SINGLECOMBOPLAY = "EVENT_SC_BATTLESHOW_SINGLECOMBOPLAY", --播放单个战斗连击表演
    EVENT_SC_BATTLESHOW_HINTAUTOENERGY = "EVENT_SC_BATTLESHOW_HINTAUTOENERGY", --提示每回合环境能量变化量
    EVENT_SC_BATTLESHOW_MASK = "EVENT_SC_BATTLESHOW_MASK", --遮罩开启/关闭
    EVENT_SC_BATTLESHOW_CLOSE_BLACKSCENE_TIPS = "EVENT_SC_BATTLESHOW_CLOSE_BLACKSCENE_TIPS", --关闭黑幕的技能提示
    --超丽芙预热
    ...
    --正逆塔
    EVENT_TWO_SIDE_TOWER_POINT_SWEEP = "EVENT_TWO_SIDE_TOWER_POINT_SWEEP", --节点扫荡
    EVENT_TWO_SIDE_TOWER_FEATURE_FORBID = "EVENT_TWO_SIDE_TOWER_FEATURE_FORBID", --特性禁用
    --装备推荐
    ...
    EVENT_RESTAURANT_ORDER_STATE_CHANGE = "EVENT_RESTAURANT_ORDER_STATE_CHANGE", --订单状态改变
    ...
    -- 海外返回键事件
    EVENT_BACK_UIMAIN = "EVENT_BACK_UIMAIN",

    -- 特殊玩法Esc事件
    EVENT_ACTIVITY_GAME_ESC = "EVENT_ACTIVITY_GAME_ESC",
}
