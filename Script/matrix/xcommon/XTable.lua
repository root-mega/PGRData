XTable = {
    ...
    XTableCharDetail = {
        ...
        LiberationShowType = {ValueType = "bool"},
    },
    ...
    XTableStageRelatePoint = {
        StageId = {ValueType = "int"},
        RelateStageId = {Type = 1, ValueType = "int"},
    },
    ...
    XTableCameraParam = {
        ...
        BoundsCenterX = {ValueType = "float"},
        BoundsCenterY = {ValueType = "float"},
        BoundsCenterZ = {ValueType = "float"},
        BoundsSizeX = {ValueType = "float"},
        BoundsSizeY = {ValueType = "float"},
        BoundsSizeZ = {ValueType = "float"},
    },
    XTableFlopReward = {
        Id = {ValueType = "int"},
    ...
    XTableBossSingleDistribute = {
        Id = {ValueType = "int"},
        GroupDistributeId = {Type = 1, ValueType = "int"},
    },
    ...
    XTableWaveRevise = {
        ...
        AttribReviseId = {ValueType = "int"},
        ArenaAttribTypes = {Type = 1, ValueType = "int"},
        ArenaAttribValues = {Type = 1, ValueType = "int"},
    },
    XTableNpcType = {
        Id = {ValueType = "int"},
        Name = {ValueType = "string"},
    ...
    XTableUiPanelTip = {
        ...
        Priority = {ValueType = "int"},
        SkipId = {ValueType = "int"},
        LeaveRedDot = {ValueType = "bool"},
        LeavePanel = {ValueType = "bool"},
    },
    XTableShopGroup = {
        Id = {ValueType = "int"},
    ...
    XTableLoading = {
        ...
        Weight = {ValueType = "int"},
        ShowCondition = {Type = 1, ValueType = "int"},
    },
    XTableCustomLoading = {
        Id = {ValueType = "int"},
        Rate = {ValueType = "int"},
    ...
    XTableTopControlConfig = {
        Id = {ValueType = "int"},
        FontSize = {Type = 1, ValueType = "int"},
        HandleScale = {Type = 1, ValueType = "float"},
    },
    ...
    XTableCommonBall = {
        ...
        FillBarEffect = {ValueType = "string"},
    },
    ...
    XTableTwoSideTowerActivity = {
        ...
        Name = {ValueType = "string"},
        BannerBg = {ValueType = "string"},
        OutSideTimeId = {ValueType = "int"},
        InsideTimeId = {ValueType = "int"},
        OutSideBannerBg = {ValueType = "string"},
        InsideBannerBg = {ValueType = "string"},
        LimitTaskId = {ValueType = "int"},
        InsideLimitTaskId = {ValueType = "int"},
        ChapterIds = {Type = 1, ValueType = "int"},
        InsideChapterIds = {Type = 1, ValueType = "int"},
        RobotIds = {Type = 1, ValueType = "int"},
    },
    ...
    XTableTheatre3ContentLib = {
        ...
        AtkFactor = {ValueType = "int"},
        HpFactor = {ValueType = "int"},
    },
    ...
    XTableTheatre3Equip = {
        ...
        GlobalFightEventIds = {Type = 1, ValueType = "int"},
    ...
    XTableBlackRockChessActivity = {
        ...
        TimeId = {ValueType = "int"},
        Name = {ValueType = "string"},
        Chapters = {Type = 1, ValueType = "int"},
        MaxEnergy = {ValueType = "int"},
        DefaultWeapon = {ValueType = "int"},
        RoundEnergyAdd = {ValueType = "int"},
        KillEnergyAdd = {ValueType = "int"},
        ShopIds = {Type = 1, ValueType = "int"},
    },
    ...
    XTableBlackRockChessStage = {
        Id = {ValueType = "int"},
        LayoutId = {ValueType = "int"},
        ReinforceIds = {Type = 1, ValueType = "int"},
        BuffIds = {Type = 1, ValueType = "int"},
        InitEnergy = {ValueType = "int"},
        ReviveCount = {ValueType = "int"},
        MinGuaranteeReviveCount = {ValueType = "int"},
        TargetConditions = {Type = 1, ValueType = "int"},
        FirstPassRewardId = {ValueType = "int"},
        FirstPassWeaponId = {ValueType = "int"},
        FirstPassSkillId = {ValueType = "int"},
        FirstPassBuffIds = {Type = 1, ValueType = "int"},
        StarRewardTemplateId = {ValueType = "int"},
        ScenePrefab = {ValueType = "string"},
        StageIcon = {ValueType = "string"},
        Name = {ValueType = "string"},
        TargetDesc = {ValueType = "string"},
        HelpKey = {ValueType = "string"},
        EnterStoryId = {ValueType = "string"},
        ExitStoryId = {ValueType = "string"},
    },
    XTableBlackRockChessReinforce = {
        Id = {ValueType = "int"},
        Type = {ValueType = "int"},
        TriggerCd = {ValueType = "int"},
        PreviewCd = {ValueType = "int"},
        SummonCount = {ValueType = "int"},
        Locations = {Type = 1, ValueType = "string"},
        PieceIds = {Type = 1, ValueType = "int"},
    },
    ...
    XTableBlackRockChessPiece = {
        ...
        Type = {ValueType = "int"},
        MaxLife = {ValueType = "int"},
        InitMoveCd = {ValueType = "int"},
        MoveCd = {ValueType = "int"},
        PromotionPiece = {ValueType = "int"},
        BuffIds = {Type = 1, ValueType = "int"},
        Desc = {ValueType = "string"},
        Note = {ValueType = "string"},
        Prefab = {ValueType = "string"},
    ...
    XTableBlackRockChessWeaponSkill = {
        ...
        Range = {ValueType = "int"},
        IsDefault = {ValueType = "int"},
        IsPassive = {ValueType = "int"},
        IsDizzy = {ValueType = "int"},
        Params = {Type = 1, ValueType = "int"},
        Desc = {ValueType = "string"},
        Name = {ValueType = "string"},
        Icon = {ValueType = "string"},
        MapIcon = {ValueType = "string"},
        UnlockDesc = {ValueType = "string"},
        AttackAnimName = {ValueType = "string"},
        AttackTimeLine = {ValueType = "string"},
        EffectId = {Type = 1, ValueType = "int"},
        EffectDelay = {Type = 1, ValueType = "int"},
        HitEffectId = {Type = 1, ValueType = "int"},
        CueId = {ValueType = "int"},
        HitCueId = {ValueType = "int"},
    },
    ...
    XTableBlackRockChessArchive = {
        ...
        Name = {ValueType = "string"},
        Condition = {ValueType = "int"},
        UnlockTip = {ValueType = "string"},
        ArchiveTitle = {ValueType = "string"},
        ArchiveDesc = {ValueType = "string"},
    },
    ...
    XTableBlackRockChessEffect = {
        Id = {ValueType = "int"},
        Note = {ValueType = "string"},
        EffectPrefab = {ValueType = "string"},
        Offset = {ValueType = "string"},
        Rotate = {ValueType = "string"},
    },
